...
####  FOR ANY SUGGESTION CONTACT :@umeshshinde19 on Instagram!
...
###   Contact me on Instagram : @umeshshinde19 for the Pro Version

-----------------------------------------------------------------------------------------------------------------------------

## BLACKEYE v1.0
### Coded by: @thelinuxchoice (https://github.com/thelinuxchoice/blackeye)
### Upgraded by: @umeshshinde19 (https://github.com/whiteeagle0/blackeye)

#### Credits (Copyright)
#### Phishing Pages generated by Umesh Shinde (https://github.com/umeshshinde19):
Instagram
...
#### Phishing Pages generated by @umeshshinde19 (https://github.com/whiteeagle0/blackeye):
...
### Usage:
```
git clone https://github.com/umeshshinde19/BLACKEYE.git
cd blackeye
bash blackeye.sh
```
